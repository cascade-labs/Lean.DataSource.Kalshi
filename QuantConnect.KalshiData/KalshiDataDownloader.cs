/*
 * Kalshi Data Downloader
 * IDataDownloader wrapper for KalshiDataProvider
 */
...
{
    /// <summary>
    /// Data downloader that uses KalshiDataProvider for historical data
    /// </summary>
    public class KalshiDataDownloader : IDataDownloader, IDisposable
    {
        private readonly KalshiDataProvider _historyProvider;
        private readonly MarketHoursDatabase _marketHoursDatabase;

        /// <summary>
        /// Initializes a new instance of the <see cref="KalshiDataDownloader"/> class
        /// </summary>
        public KalshiDataDownloader()
        {
            _historyProvider = new KalshiDataProvider();
